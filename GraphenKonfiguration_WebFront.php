...
define('FARBE_GRAPHEN_RAND', '#111122');
define('FARBE_PLOT_BEREICH', '#FFFFFF@0.0'); //weiß

//Legende
define('ZEIGE_LEGENDE', TRUE);
define('ZEIGE_LEGENDEN_SCHATTEN', FALSE); //kann auch eine Farbe sein
define('DICKE_LEGENDEN_SCHATTEN', 2);
define('FARBE_LEGENDEN_RAHMEN', 'black@1');
define('DICKE_LEGENDEN_RAHMEN', 0);
define('FARBE_LEGENDEN_SCHRIFT', 'white');
define('FARBE_LEGENDE_FUELLEN', 'black@1');
...
//Farben der Achsen
define('FARBE_X_ACHSE', 'white'); //schwarz
define('FARBE_Y1_ACHSE', 'white');
define('FARBE_Y2_ACHSE', 'white'); //rot
...
//Gitternetzlinien
define('FARBE_XGRID_LINIEN', '#FFFFFF@0.9');
define('FARBE_YGRID_LINIEN', '#FFFFFF@0.9');
...
define('FARBE_YGITTER_FUELLEN_1',  '#283040@0.0');
define('FARBE_YGITTER_FUELLEN_2',  '#283040@0.0');

//Schriftfarben
define('FARBE_TITEL',  'white@0.1'); //schwarz
define('FARBE_UNTERTITEL',  'white'); //schwarz
define('FARBE_EINHEIT_Y1',  'white'); //schwarz
define('FARBE_EINHEIT_Y2',  'white'); //schwarz
...
define('FARBE_BALKEN_WERTE', 'white');
