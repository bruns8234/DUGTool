<?
//==================================================================================
// Datei.......: graphenanlegeneinfach.php
...
<html>
  <head>
    ...
    <meta name="Dateiname"    content="graphenanlegeneinfach.php">
      ...
      <form name="graphneu"  method="post" action="graphneu.php" target="_self">
        <table class="tab_normal" witdh="100%" cellspacing="3" cellpadding="3" >
          ...
          <tr class="tab_normal_line">
			...
			<td align="left"> <select name="gerstintervall" size="1">
<?
									foreach($NEUERSTELLUNGSINTERVALL as $zeitintervall => $bezeichnung)
									{
										echo "<option value=\"".$zeitintervall."\" ".($zeitintervall == $NEUERSTELLUNGSINTERVALLSTD? "selected" : "").">".$bezeichnung."</option>";
									}
?>
							  </select>
			</td>
			<td align="left"> <select name="gdarintervall" size="1">
<?
								foreach($DARSTELLUNGSINTERVALL as $zeitintervall => $bezeichnung)
								{
									echo "<option value=\"".$zeitintervall."\" ".($zeitintervall == $DARSTELLUNGSINTERVALLSTD? "selected" : "").">".$bezeichnung."</option>";
								}
?>
							</select>
			</td>
...
?>
		...
		<input type="hidden" name="vardarst[<?echo $i; ?>]" value="<?echo ((int)$dbvarinfo['Typ'] == 2 ? '0' : '1');?>">
...
?>
        ...
        <br>
		<input type="hidden" name="gerstoffset" value="<?echo $ERSTELLUNGSOFFSETSTD;?>">
