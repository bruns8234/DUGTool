<?
//==================================================================================
// Datei.......: variableipsnameuebern.php
// Beschreibung: Übernimmt den aktuellen IPS Pfad und Name einer Variable als neunen Namen der Variablen in die Datenbank
//
// DUG Version.....: V1.6
...
<html>
  <head>
    ...
    <meta name="Dateiname"    content="variableipsnameuebern.php">
...
Variablennamen aus IPS &uuml;bernehmen  </span>
<br>
<br>
<br>
<?
...
if (isset($_REQUEST['variable']))
{
	...
	{
		if (IPS_VariableExists((int)$v[5]))
		{
			$varPfad = IPS_GetLocation((int)$v[5]);
			...
			$select = $select."UPDATE Variable SET 'Name' = '".$varPfad."' WHERE ID ='".$v[0]."'; ";
			$select = $select."\r \n";
			echo "Variable umbenannt: ".stripslashes($v[1])." ==> ".$varPfad.";<br>";
		}else
		{
			echo "Variable ".stripslashes($v[1])." existiert in IPS nicht mehr.<br>";
		}
